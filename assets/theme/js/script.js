...
(function () {
  ...
  function r(a) {
    ...
    (function c() {
      ...
      1 < (b += 0.1) || ((a.style.opacity = b), requestAnimationFrame(c));
    })();
  }
  function w(a) {
    var b = [],
  ...
  function E(a) {
    ...
    if (c) {
      ...
      for (var k = 0; k < c.length; k++)
        b.push('"' + c[k].getAttribute("stop-color") + '"');
      b = '"lineargradient": [' + b + "],";
  ...
  function x(a, b, c) {
    ...
    f.getAttribute("style") ||
      f.setAttribute("style", "-webkit-flex-basis: auto; flex-basis: auto;");
  ...
  Element.prototype.parents = function (a) {
    for (
      var b = [], c = this, d = void 0 !== a;
      null !== (c = c.parentElement);

    )
      c.nodeType === Node.ELEMENT_NODE && ((d && !c.matches(a)) || b.push(c));
    return b;
  };
  ...
  l(function () {
    ...
    if (t)
      g(document).on("add.cards delete.cards", function (a) {
        ...
        k = setTimeout(function () {
          ...
          a &&
            ((q = { breakPoint: h(a).top + 3 * d(a), fixed: !1, elm: a }),
    ...
    if (m)
      g(document).on("changeParameter.cards", function (a, b, e, f) {
        if ("bg" === b)
          switch (f) {
            case "type":
          ...
          a.addEventListener("counter.social-likes", function (a, b, e) {
            999 < e &&
              a.target
                ...
                .forEach(function (a) {
                  a.innerHTML = Math.floor(e / 1e3) + "k";
                });
          });
...
!(function () {
  ...
  if (!document.getElementById("top-1")) {
    ...
    a.style = "display: none";
    a.innerHTML =
      '<a href="https://mobirise.in">Mobirise Easy Website Software</a> Mobirise v5.5.0';
